  ...
  return (
    <main className="mx-auto max-w-4xl px-5 py-16 sm:px-8">
      ...
      <div className="mt-5 flex flex-col justify-between gap-8 sm:flex-row sm:items-end">
        <div><h1 className="heading-lg text-heading-lg text-ink-black">Your workspace</h1><p className="mt-4 text-lg text-pewter">Manage the identity connected to your repository intelligence workspace.</p></div>
      ...
      <section className="mt-12 rounded-[32px] border border-sand bg-pure-white p-7 sm:p-9">
