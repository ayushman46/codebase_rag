  ...
  return (
    <main className="mx-auto max-w-6xl px-5 py-16 sm:px-8">
      <div className="mx-auto max-w-2xl text-center">
        ...
        <h1 className="heading-lg mt-5 text-heading-lg text-ink-black">Start with a secure personal workspace.</h1>
      ...
      <div className="mx-auto mt-14 grid max-w-4xl gap-6 md:grid-cols-2">
        {plans.map((plan) => (
          <article key={plan.name} className={`relative rounded-[32px] border p-8 ${plan.featured ? 'border-ember-orange bg-ink-black text-pure-white shadow-[0_20px_60px_rgba(14,14,15,0.18)]' : 'border-sand bg-pure-white text-ink-black'}`}>
