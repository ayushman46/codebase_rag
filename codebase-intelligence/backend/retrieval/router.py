...
async def classify_query(question: str) -> str:
    ...
    # Force high-level questions to full_context to ensure relevant project overviews
    ...
    try:
        ...
        if "full_context" in category:
            return "full_context"
        elif "cached_summary" in category:
            return "cached_summary"
        else:
            return "rag"
    except Exception as e:
        print(f"Router error: {e}")
        # Default to rag safely
        return "rag"